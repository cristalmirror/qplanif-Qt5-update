...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_NUM = 3,                        /* NUM  */
  YYSYMBOL_TAREA = 4,                      /* TAREA  */
  YYSYMBOL_RECURSO = 5,                    /* RECURSO  */
  YYSYMBOL_CPU = 6,                        /* CPU  */
  YYSYMBOL_OFFSET = 7,                     /* OFFSET  */
  YYSYMBOL_PERIODO = 8,                    /* PERIODO  */
  YYSYMBOL_PRIORIDAD = 9,                  /* PRIORIDAD  */
  YYSYMBOL_IDEN = 10,                      /* IDEN  */
  YYSYMBOL_11_ = 11,                       /* '='  */
  YYSYMBOL_12_ = 12,                       /* '['  */
  YYSYMBOL_13_ = 13,                       /* ','  */
  YYSYMBOL_14_ = 14,                       /* ']'  */
  YYSYMBOL_YYACCEPT = 15,                  /* $accept  */
  YYSYMBOL_b_inicio = 16,                  /* b_inicio  */
  YYSYMBOL_17_1 = 17,                      /* $@1  */
  YYSYMBOL_b_recursos = 18,                /* b_recursos  */
  YYSYMBOL_19_2 = 19,                      /* $@2  */
  YYSYMBOL_b_tareas = 20,                  /* b_tareas  */
  YYSYMBOL_21_3 = 21,                      /* $@3  */
  YYSYMBOL_b_linea_recurso = 22,           /* b_linea_recurso  */
  YYSYMBOL_b_linea_tarea = 23,             /* b_linea_tarea  */
  YYSYMBOL_24_4 = 24,                      /* $@4  */
  YYSYMBOL_b_atributos = 25,               /* b_atributos  */
  YYSYMBOL_b_patron_uso = 26,              /* b_patron_uso  */
  YYSYMBOL_27_5 = 27                       /* $@5  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "NUM", "TAREA",
  "RECURSO", "CPU", "OFFSET", "PERIODO", "PRIORIDAD", "IDEN", "'='", "'['",
  "','", "']'", "$accept", "b_inicio", "$@1", "b_recursos", "$@2",
  "b_tareas", "$@3", "b_linea_recurso", "b_linea_tarea", "$@4",
  "b_atributos", "b_patron_uso", "$@5", YY_NULLPTR
};
...
{
     -22,     6,     2,   -22,   -22,     3,     5,     0,   -22,     7,
     -22,     4,   -22,   -22,    -7,     1,     8,     9,    10,    12,
      13,    14,    15,   -22,    -7,    -7,    -7,    11,   -22,   -22,
     -22,    18,    -1,   -22,    10,   -22
};
...
{
       6,     0,     2,     1,     9,     0,     3,     0,     5,    13,
      10,     0,     8,    11,    17,     0,     0,     0,    20,     0,
       0,     0,     0,    12,    17,    17,    17,     0,    15,    14,
      16,     0,     0,    18,    20,    19
};
...
{
      15,    16,    17,    28,    29,    30,     3,    -4,     7,    -7,
      10,    11,    19,    33,    13,    24,    25,    26,    27,    20,
      21,    32,    22,    35,    31
};

static const yytype_int8 yycheck[] =
{
       7,     8,     9,    24,    25,    26,     0,     5,     5,     4,
      10,     4,    11,    14,    10,     3,     3,     3,     3,    11,
      11,     3,    12,    34,    13
};
...
{
       0,    16,    18,     0,    17,    19,    20,     5,    22,    21,
      10,     4,    23,    10,    24,     7,     8,     9,    25,    11,
      11,    11,    12,    26,     3,     3,     3,     3,    25,    25,
      25,    13,     3,    14,    27,    26
};
...
{
       0,    15,    17,    16,    19,    18,    18,    21,    20,    20,
      22,    24,    23,    23,    25,    25,    25,    25,    27,    26,
      26
};
...
#ifdef DEBUG
	       printf("(%d)<%d -- %d> \n",*r, (yyvsp[-3].ivalue), (yyvsp[-1].ivalue));
#endif
	       Tareas[num_tareas].subtarea[*r].recurso = (yyvsp[-3].ivalue);
